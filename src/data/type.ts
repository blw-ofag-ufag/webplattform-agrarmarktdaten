...
export const bioColors = [M.colors.green, M.colors.brown];
...
export const backgroundStyle = (color: string) => {
  return {
    ...
    three: {
      backgroundColor: color,
      border: `2px solid ${color}`,
      backgroundImage: `radial-gradient(${M.colors.yellow} 20%, transparent 0),
      radial-gradient(${M.colors.yellow} 20%, transparent 0)`,

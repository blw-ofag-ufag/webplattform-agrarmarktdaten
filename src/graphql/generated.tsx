...
export const ImageTeaserBlockFragmentDoc = gql`
  ...
  imageTeaserAsset {
    ...
    width
    height
    responsiveImage(imgixParams: {fit: fill, w: 1376, h: 485.25, auto: format}) {
      sizes
      src
      width
      height

...
Editing content occurs through the [Dato dashboard](https://datocms.com). The content must be edited in all languages. The CMS is organized according to the structure of the website.
